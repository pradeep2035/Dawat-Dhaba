    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: todaySpecial.isEmpty && categoryList.isEmpty? Center(
                ...
                const Row(
                  children: [
                    ...
                    Text(
                      "See all",
                      style: TextStyle(
                          fontSize: 15, color: Color.fromARGB(255, 234, 163, 71)),
                    ),
                  ],
                ),
                SizedBox(
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          onTap: (){
                            Get.to(()=>MenuItemPage(categoryName:categoryName,categoryId:categoryId));
                          },
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        ...
                                        offset: const Offset(
                                            6, 3), // Offset in the x, y direction
                                      ),
                                    ],
                                  ...
                                  child: ClipOval(
                                    child: Image.network(
                                      categoryList[index]["category_Image_url"],
                                      height: 80,
                                      width: 80,
                                      fit: BoxFit.cover,
                                    ),
